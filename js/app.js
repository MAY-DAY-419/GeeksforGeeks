    ...
    if (toggle && header) {
        toggle.addEventListener('click', function() {
            if (!mobileMenu) {
                ...
                mobileMenu.innerHTML = '\n                <div class="container mx-auto px-6 py-4 flex flex-col gap-4">\n                    <a href="#events" class="text-gray-300 hover:text-emerald-400 transition-colors">Events</a>\n                    <a href="Registration.html" class="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-black font-bold rounded-full transition-all duration-300 w-max">Register</a>\n                </div>\n                ';
